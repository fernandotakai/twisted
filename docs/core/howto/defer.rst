...
.. code-block:: python
    ...
    def main(reactor):
        ...
        d = defer.Deferred()
        d.addBoth(called, 2, start_time, reactor)
        d.addBoth(called, 2, start_time, reactor)
        d.addBoth(called, 2, start_time, reactor)
    ...
    # Results should be the following prints:
    #   Called after 0 seconds with result 'Start!'
    #   Called after 2 seconds with result None
    #   Called after 4 seconds with result None
    #   Called after 5 seconds with result <twisted.python.failure.Failure twisted.internet.defer.TimeoutError: (5, 'Deferred')>
    #   Called after 7 seconds with result None
